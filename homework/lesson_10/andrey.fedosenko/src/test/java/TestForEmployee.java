...
public class TestForEmployee {
  ...
  public void simpleFixedPriceTest_whenWorkedSeveralWholePaymentPeriod_shouldReceivePaymentForAll() {
    ...
    worker1.setWorkingHours(Payable.WORKING_HOURS_PER_DAY * WORKING_DAYS_PER_MONTH * 10);
    assertThat((double)worker1.calculatePayment(), is(closeTo(10.00 * WORKING_DAYS_PER_MONTH * 10, 0.01)));
  }
