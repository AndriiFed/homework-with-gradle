...
public class ArrayListTest {
  ...
  public void testStringConcat() {
    ...
    assertThat(result, is("Hello Teddy Bear Array"));
  }

  public void testStringReverseConcat() {
    List<String> list = new ArrayList<>();
    ...
    String result = "";
    ReverseIterator<String> iter = list.reverseIterator();
  ...
  public void randomIteratorTest() {
    ...
    assertThat(list.randomIterator().next(), anyOf(is(10), is(20), is(30), is(40), is(50)));
  }
}
